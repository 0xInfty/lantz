# -*- coding: utf-8 -*-
#
# Lantz documentation build configuration file, created by
...
latex_documents = [
  ('index', 'lantz.tex', 'Lantz Documentation',
   'Hernán E. Grecco', 'manual'),
]
...
man_pages = [
    ('index', 'lantz', 'Lantz Documentation',
     ['Hernán E. Grecco'], 1)
]
...
texinfo_documents = [
  ('index', 'lantz', 'lantz Documentation',
   'Hernan E. Grecco', 'lantz', 'One line description of project.',
   'Miscellaneous'),
]
